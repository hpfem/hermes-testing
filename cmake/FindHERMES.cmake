...
if(${HERMES_VERSION} STREQUAL "HERMES2D")
  if(WIN64)
    FIND_LIBRARY(HERMES_LIBRARY NAMES hermes2d_64 PATHS ${HERMES_DIRECTORY} /usr/lib /usr/local/lib NO_DEFAULT_PATH)
  else()
    FIND_LIBRARY(HERMES_LIBRARY NAMES hermes2d PATHS ${HERMES_DIRECTORY} /usr/lib /usr/local/lib NO_DEFAULT_PATH)
  endif()
