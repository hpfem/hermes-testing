...
if(WIN64)
  FIND_LIBRARY(HERMES_COMMON_LIBRARY NAMES hermes_common_64 PATHS ${HERMES_DIRECTORY} /usr/lib /usr/local/lib NO_DEFAULT_PATH)
else()
  FIND_LIBRARY(HERMES_COMMON_LIBRARY NAMES hermes_common PATHS ${HERMES_DIRECTORY} /usr/lib /usr/local/lib NO_DEFAULT_PATH)
endif()
