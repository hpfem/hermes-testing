...
echo "Run visualization tests? (y-yes, anything else:no) (Short)"
read ans
if [ "$ans" = "y" ]; then
...
echo "Run load-save tests? (y-yes, anything else:no) (Short)"
read ans
if [ "$ans" = "y" ]; then
...
echo "Run calculations tests? (y-yes, anything else:no) (Very short)"
read ans
if [ "$ans" = "y" ]; then
