...
int main(int argc, char* argv[])
{
  ...
  CustomVolumeIntegralCalculator volume_integral(std::vector<MeshFunctionSharedPtr<double> >({ exact_sln, exact_sln }), random_number);
  CustomSurfaceIntegralCalculator surface_integral(std::vector<MeshFunctionSharedPtr<double> >({ exact_sln, exact_sln }), random_number);
  ...
  CustomVolumeIntegralCalculator volume_integral2(std::vector<MeshFunctionSharedPtr<double> >({ exact_sln2, exact_sln2 }), random_number);
  CustomSurfaceIntegralCalculator surface_integral2(std::vector<MeshFunctionSharedPtr<double> >({ exact_sln2, exact_sln2 }), random_number);

  std::vector<double> volumetric_int;
  std::vector<double> surface_int;
  try
  {
    volumetric_int.push_back(volume_integral2.calculate(std::vector<std::string>({ "1", "2" }))[random_number / 2]);
  }
  ...
  try
  {
    volumetric_int.push_back(volume_integral2.calculate(std::vector<std::string>({ "1", "3" }))[random_number / 2]);
  }
  catch(Hermes::Exceptions::Exception& e)
  {
    e.print_msg();
  ...
  try
  {
    volumetric_int.push_back(volume_integral2.calculate(std::vector<std::string>({ "2", "4" }))[random_number / 2]);
  }
  catch(Hermes::Exceptions::Exception& e)
  {
    e.print_msg();
  ...
  try
  {
    volumetric_int.push_back(volume_integral2.calculate(std::vector<std::string>({ "3", "4", "5" }))[random_number / 2]);
  }
  catch(Hermes::Exceptions::Exception& e)
  {
    e.print_msg();
  ...
  CustomVolumeIntegralCalculator volume_integral3(std::vector<MeshFunctionSharedPtr<double> >({ exact_sln_whole, exact_sln_hole }), random_number);
  CustomSurfaceIntegralCalculator surface_integral3(std::vector<MeshFunctionSharedPtr<double> >({ exact_sln_hole, exact_sln_whole }), random_number);
