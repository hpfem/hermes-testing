...
{
public:
  CustomExactSolution(MeshSharedPtr mesh) : ExactSolutionVector<std::complex<double> >(mesh) {};
  ~CustomExactSolution() {};
...
{
public:
  CustomWeakForm(double mu_r, double kappa) : WeakForm<std::complex<double> >(1)
  {
